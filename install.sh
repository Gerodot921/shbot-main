...
read_input "Какой порт вы будете использовать для вебхуков Lava.top? (443 или 8443, рекомендуется 443): " LAVA_PORT_INPUT
LAVA_PORT=${LAVA_PORT_INPUT:-443}
...
echo -e "  - ${YELLOW}https://${DOMAIN}:${LAVA_PORT}/login${NC}"
...
echo -e "\n${CYAN}Не забудьте указать URL для вебхуков в Lava.top:${NC}"
echo -e "  - ${YELLOW}https://${DOMAIN}:${LAVA_PORT}/lava-webhook${NC}"
echo -e "\n"
