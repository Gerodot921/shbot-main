...
- **Интеграция с Lava.top**: Автоматический прием платежей и выдача доступа после оплаты.
...
```bash
curl -sSL https://raw.githubusercontent.com/Gerodot921/shbot-main/main/install.sh | sudo bash
```
...
Введите **API Key** и **Offer ID** из вашего личного кабинета Lava.top.

Если хотите проверять вебхуки отдельным ключом, укажите его в поле **Ключ для проверки вебхука X-Api-Key**.

Сохраните настройки.

В личном кабинете Lava.top укажите **URL для вебхуков:**
https://your-domain.com/lava-webhook
_(Замените your-domain.com на ваш домен. Если при установке вы выбрали порт 8443, укажите его: https://your-domain.com:8443/lava-webhook)_

Для успешной работы вебхука добавьте событие **Payment result**. Если планируете рекуррентные платежи, добавьте и **Recurring payment**.
